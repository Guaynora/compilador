...
})()(
  {
    1: [
      function (require, module, exports) {
        (function (root, factory) {
          ...
          function isObject(o) {
            return (
              o && typeof o === "object" && !isRegExp(o) && !Array.isArray(o)
            );
          }
          ...
          function keywordTransform(map) {
            ...
            for (var i = 0; i < types.length; i++) {
              ...
              keywordList.forEach(function (keyword) {
                (byLength[keyword.length] =
                  byLength[keyword.length] || []).push(keyword);
          ...
          Lexer.prototype._token = function (group, text, offset) {
            ...
            var token = {
              type:
                ...
                group.defaultType,
              value:
                typeof group.value === "function" ? group.value(text) : text,
              text: text,
        ...
        (function (root, factory) {
          ...
          Parser.prototype.feed = function (chunk) {
            ...
            while (true) {
              ...
              var value =
                lexer.constructor === StreamLexer ? token.value : token;
    ...
    */
          Parser.prototype.buildFirstStateStack = function (state, visited) {
            ...
            var childResult = this.buildFirstStateStack(
              prevState,
              childVisited
            );
            if (childResult === null) {
          ...
          var grammar = {
            ...
            ParserRules: [
              ...
              { name: "statement", symbols: ["fun_call"], postprocess: id },
              {
                name: "var_assign",
                symbols: [
                  myLex.has("identifier") ? { type: "identifier" } : identifier,
                  "_",
                  { literal: "=" },
                  "_",
                  "expr",
              ...
              {
                name: "fun_call$ebnf$1$subexpression$1",
                symbols: ["arg_list", "_"],
              },
              {
              ...
              {
                name: "expr",
                symbols: [myLex.has("string") ? { type: "string" } : string],
                postprocess: id,
              },
              {
                name: "expr",
                symbols: [myLex.has("number") ? { type: "number" } : number],
                postprocess: id,
              },
              {
                name: "expr",
              ...
              {
                name: "_$ebnf$1",
                symbols: ["_$ebnf$1", myLex.has("WS") ? { type: "WS" } : WS],
              ...
              {
                name: "__$ebnf$1",
                symbols: [myLex.has("WS") ? { type: "WS" } : WS],
              },
              {
                name: "__$ebnf$1",
                symbols: ["__$ebnf$1", myLex.has("WS") ? { type: "WS" } : WS],
                postprocess: function arrpush(d) {
                  return d[0].concat([d[1]]);
                },
              },
    ...
    5: [
      ...
      { "./generate.js": 3, "./parser.js": 6, "./tokenizer.js": 7 },
    ],
    6: [
      function (require, module, exports) {
